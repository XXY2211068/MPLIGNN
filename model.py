...
class DIRGNN(Module):
    ...
    def compute_scores(self, hidden, mask, target_emb, A_hat, D_hat, inputs):
    ...
    def forward(self, A_global, inputs_global, inputs_global_index, alias_inputs):
        ...
        return seq_hidden_gnn, target_emb
...
def forward(model, i, data):
    ...
    hidden, target_emb = model(A_global, inputs, global_inputs_index, alias_inputs)
    scores = model.compute_scores(hidden, mask, target_emb, A_hat, D_hat, items)
